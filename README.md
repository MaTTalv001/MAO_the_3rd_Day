...
- 習慣づけ支援: 毎日の活動を記録して、目標達成への道を楽しくサポートします。
- RPG の世界観: ゲーム感覚で習慣づけを続けられます。
- カスタマイズ可能: 活動に応じてキャラクターが成長。オリジナルアバターをAIで生成することもできます。
- 報酬システム: 活動や魔王退治で金貨を獲得し、アイテムと交換できます。
- バトル: 1 日 1 回のモンスター討伐、や魔王戦。コマンドバトルで勝利を掴み、報酬を手に入れます。
- 酒場モード(コミュニティ機能): 他のユーザーのデザインやステータスを閲覧できます。
...
- 一方で一旦習慣化された事柄は長期間に渡って定着できる。3 日目を乗り越えられるかが大きい
...
- デジタルデバイスに精通しており、新しいアプリに対しても抵抗が少ないです。ゲーム化された要素にも自然と親しみやすい一方で、UX には厳しく第一印象が重要になると考えます。
- 習慣形成の重要性: 人生の早い段階で良い習慣を身につけることは、長期的に見て非常に有益。

#### 働き盛りの成人（30 代〜40 代）

- 忙しい日常の中での自己改善: 仕事や家庭で忙しい中、自己改善の時間を見つけることが難しい状況です。短い時間でも習慣化に取り組める枠組みが必要。
- ノスタルジー: 往年のレトロ RPG デザインは、この年代のユーザーにとって懐かしさを感じさせる要素。


#### 利用方法

- PC、スマートフォンいずれも操作できます。気楽に入力できる UI を提供します。



## サービスの差別化ポイント・推しポイント

活動記録とゲーミフィケーションで継続を支援するアプリはあります。例えば学習や筋トレなど、それぞれが個別のタスクに特化している場合が多いですが、このアプリでは RPG の世界観を活かし、勉強でも運動でも、子育てでも、ユーザーさまざまな活動をこのアプリにフィッティングすることができ、一元管理ができます。
...
## ER 図（開発開始時点）
![MAO_ER (4)](https://github.com/MaTTalv001/MAO_the_3rd_Day/assets/148398286/bff4d915-d4cd-4186-a7b7-8220bb318115)
